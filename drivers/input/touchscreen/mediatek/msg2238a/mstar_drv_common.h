...
#define DEBUG_LEVEL(level, fmt, arg...) do {\
	                                               pr_err("[CTP-msg2xxx] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)\
                                        } while (0)

#define DBG(fmt, arg...) pr_err("[CTP-msg2xxx] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)

#define CTP_DBG(fmt, arg...) \
	pr_err("[CTP-msg2xxx] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
#define TPD_PROXIMITY_DBG(fmt, arg...) \
	pr_err("[CTP-proxi_msg2xxx] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
...
#define MSTAR_CTP_VENDOR_HOLITECH      (0x10)
