...
#define DEBUG_LEVEL(level, dev, fmt, arg...) do {\
	                                               pr_err("ILITEK %s, lind = %d,"fmt, __func__, __LINE__, ##arg);\
                                        } while (0)
...
#define CTP_DBG(fmt, arg...) \
	pr_err("[CTP-ILITEK] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
#define TPD_PROXIMITY_DBG(fmt, arg...) \
	pr_err("[CTP-proxi_ILITEK] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
...
#define ILITEK_CTP_VENDOR_HOLITECH      (0x10)
