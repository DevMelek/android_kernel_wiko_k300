...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_DW9714AF_S5K4H8_SUNWIN, DW9714AF_S5K4H8_SUNWIN_SetI2Cclient, DW9714AF_S5K4H8_SUNWIN_Ioctl, DW9714AF_S5K4H8_SUNWIN_Release},
#endif
#ifdef CONFIG_MTK_LENS_DW9714AF_S5K4H8_HOLITECH_SUPPORT
	{1, AFDRV_DW9714AF_S5K4H8_HOLITECH, DW9714AF_S5K4H8_HOLITECH_SetI2Cclient, DW9714AF_S5K4H8_HOLITECH_Ioctl, DW9714AF_S5K4H8_HOLITECH_Release},
#endif
#ifdef CONFIG_MTK_LENS_DW9714VAF_SUPPORT
	{1, AFDRV_DW9714VAF, DW9714VAF_SetI2Cclient, DW9714VAF_Ioctl, DW9714VAF_Release},
#endif
	...
	{1, AFDRV_DW9714AF_GC8024_CXT_K300_AF, DW9714AF_GC8024_CXT_K300_AF_SetI2Cclient, DW9714AF_GC8024_CXT_K300_AF_Ioctl, DW9714AF_GC8024_CXT_K300_AF_Release},
#endif
#ifdef CONFIG_MTK_LENS_DW9714AF_GC8034_CXT_K300_AF_SUPPORT
	{1, AFDRV_DW9714AF_GC8034_CXT_K300_AF, DW9714AF_GC8034_CXT_K300_AF_SetI2Cclient, DW9714AF_GC8034_CXT_K300_AF_Ioctl, DW9714AF_GC8034_CXT_K300_AF_Release},
#endif
};
...
static long AF_SetMotorName(__user struct stAF_MotorName *pstMotorName)
{
	...
	for (i = 0; i < MAX_NUM_OF_LENS; i++) {
		...
		if (strcmp(stMotorName.uMotorName, g_stAF_DrvList[i].uDrvName) == 0) {
			...
			LOG_INF("Get Motor i4RetValue : %d\n", i4RetValue);
			break;
		}
	}
	return i4RetValue;
