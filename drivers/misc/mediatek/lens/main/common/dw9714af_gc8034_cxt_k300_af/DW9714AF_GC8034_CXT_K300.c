...
/*
 * DW9714AF_GC8034_CXT_K300_AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9714AF_GC8034_CXT_K300_AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long DW9714AF_GC8034_CXT_K300_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
static inline void AF_CloseDelay(void)
{
...
int DW9714AF_GC8034_CXT_K300_AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
	...
	if (*g_pAF_Opened == 2) {
		...
		s4AF_WriteReg(100);
		msleep(12);
		char puSendCmd6[2] = { 0x80, 0x00 };
		i2c_master_send(g_pstAF_I2Cclient, puSendCmd6, 2);/* Power down mode */
	}
...
int DW9714AF_GC8034_CXT_K300_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
