...
extern inline unsigned int ut_enc_memory(int dev_file_id, struct client_encode_cmd *enc, union TEEC_Parameter params, unsigned int *returnOrigin, unsigned int inout, unsigned char isTemp);
extern unsigned int ut_dec_value(struct client_encode_cmd *enc, int dev_file_id, unsigned int *returnOrigin);
