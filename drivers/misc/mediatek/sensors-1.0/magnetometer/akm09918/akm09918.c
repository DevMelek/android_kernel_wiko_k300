...
#ifdef CONFIG_ROBUST_I2C_CHECK
extern int robust_mag_i2c_check_status;
#endif
...
static int AKECS_CheckDevice(void)
{
	...
	{
		MAGN_LOG(" AKM check device not AKM device\n");
		return -ENXIO;
	}
...
int FST_AK09918(void)
{
	...
	TEST_DATA(TLIMIT_NO_SNG_ST2_09918,  TLIMIT_TN_SNG_ST2_09918,  (int)i2cData[8], TLIMIT_LO_SNG_ST2_09918,
		TLIMIT_HI_SNG_ST2_09918,  &pf_total);
