...
#include "sp250a_cmk_k100_mipi_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = SP250A_CMK_K100_MIPI_RAW_SENSOR_ID,
...
UINT32 SP250A_CMK_K100_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
