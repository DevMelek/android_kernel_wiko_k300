 ...
 * Filename:
 * ---------
 *	 hi556_cxt_k300mipiraw_sensor.c
 *
 * Project:
 * --------
...
#include "hi556_cxt_k300_mipi_raw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "hi556_cxt_k300"
#define LOG_1 printk("HI556_CXT_K300,MIPI 2LANE\n")
#define LOG_2 printk("preview 1280*960@30fps,420Mbps/lane; video 1280*960@30fps,420Mbps/lane; capture 5M@15fps,420Mbps/lane\n")
/****************************   Modify end    *******************************************/
...
#define RG_Ratio_Typical 0x114
#define BG_Ratio_Typical 0x12b
void HI556_Sensor_update_wb_gain(USHORT r_gain, USHORT b_gain, USHORT g_gain);
kal_uint16 HI556_Sensor_OTP_read(kal_uint16 otp_addr,kal_uint16 otp_addr_one,kal_uint16 otp_addr_two);
void HI556_Sensor_calc_wbdata(void);
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI556_CXT_K300_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	
	.checksum_value = 0xe48556a,		//checksum value for Camera Auto Test

	.pre = {
		.pclk = 166400000,				//record different mode's pclk
...
//[TODO]ihdr_write_shutter_gain not support for hi556_cxt_k300
...
{
    printk("hi556_otp HI556OTPSetting begin:\n ");
    ...
    printk("hi556_otp HI556OTPSetting exit :\n ");
}
...
void HI556_Sensor_OTP_info(void)
{
    ...
    printk("hi556_otp info_flag = 0x%x\n", info_flag);
    switch (info_flag)
    {
        case 0x01:
            ModuleHouseID = HI556_Sensor_OTP_read(0x0402,0,0);
			af_flag       = HI556_Sensor_OTP_read(0x0403,0,0);
            Year          = HI556_Sensor_OTP_read(0x0404,0,0);
            month         = HI556_Sensor_OTP_read(0x0405,0,0);
            day           = HI556_Sensor_OTP_read(0x0406,0,0);
            sensor_id     = HI556_Sensor_OTP_read(0x0407,0,0);
			Lens_id       = HI556_Sensor_OTP_read(0x0408,0,0);
			vcm_id        = HI556_Sensor_OTP_read(0x0409,0,0);
			devicer_ic_id = HI556_Sensor_OTP_read(0x040A,0,0);
			F_num_id      = HI556_Sensor_OTP_read(0x040B,0,0);
            break;
        case 0x13:
            ModuleHouseID = HI556_Sensor_OTP_read(0x0413,0,0);
			af_flag       = HI556_Sensor_OTP_read(0x0414,0,0);
            Year          = HI556_Sensor_OTP_read(0x0415,0,0);
            month         = HI556_Sensor_OTP_read(0x0416,0,0);
            day           = HI556_Sensor_OTP_read(0x0417,0,0);
            sensor_id     = HI556_Sensor_OTP_read(0x0418,0,0);
			Lens_id       = HI556_Sensor_OTP_read(0x0419,0,0);
			vcm_id        = HI556_Sensor_OTP_read(0x040A,0,0);
			devicer_ic_id = HI556_Sensor_OTP_read(0x040B,0,0);
			F_num_id      = HI556_Sensor_OTP_read(0x040C,0,0);
            break;
        case 0x37:
            ModuleHouseID = HI556_Sensor_OTP_read(0x0424,0,0);
			af_flag       = HI556_Sensor_OTP_read(0x0425,0,0);
			Year          = HI556_Sensor_OTP_read(0x0426,0,0);
			month         = HI556_Sensor_OTP_read(0x0427,0,0);
			day           = HI556_Sensor_OTP_read(0x0428,0,0);
			sensor_id     = HI556_Sensor_OTP_read(0x0429,0,0);
            Lens_id       = HI556_Sensor_OTP_read(0x042A,0,0);
            vcm_id        = HI556_Sensor_OTP_read(0x042B,0,0);
            devicer_ic_id = HI556_Sensor_OTP_read(0x042C,0,0);
            F_num_id      = HI556_Sensor_OTP_read(0x042D,0,0);
            break;
        default:	
            printk("hi556_otp HI556_Sensor: info_flag error value: %d \n ",info_flag);
        break;
    }
    printk("hi556_otp HI556_ModuleHouseID = %x \n", ModuleHouseID);
    printk("hi556_otp HI556_Year = %d \n", Year);
    printk("hi556_otp HI556_month = %d \n", month);
    printk("hi556_otp HI556_day = %d \n", day);	
    printk("hi556_otp HI556_sensor_id = %d \n", sensor_id);
...
void HI556_Sensor_calc_wbdata(void)
{
	...
	hi556_otp_info.wb_flag = HI556_Sensor_OTP_read(0x0435,0,0);

    switch (hi556_otp_info.wb_flag)
    {
        case 0x01:	//Group1 valid
            wb_unit_rg_h   = HI556_Sensor_OTP_read(0x0436,0,0);
            wb_unit_rg_l   = HI556_Sensor_OTP_read(0x0437,0,0);
            wb_unit_bg_h   = HI556_Sensor_OTP_read(0x0438,0,0);
            wb_unit_bg_l   = HI556_Sensor_OTP_read(0x0439,0,0);
            wb_unit_gg_h   = HI556_Sensor_OTP_read(0x043A,0,0);
            wb_unit_gg_l   = HI556_Sensor_OTP_read(0x043B,0,0);
            wb_golden_rg_h = HI556_Sensor_OTP_read(0x043C,0,0);
            wb_golden_rg_l = HI556_Sensor_OTP_read(0x043D,0,0);
            wb_golden_bg_h = HI556_Sensor_OTP_read(0x043E,0,0);
            wb_golden_bg_l = HI556_Sensor_OTP_read(0x043F,0,0);
            wb_golden_gg_h = HI556_Sensor_OTP_read(0x0440,0,0);
            wb_golden_gg_l = HI556_Sensor_OTP_read(0x0441,0,0);
            //wb_unit_r_h    = HI556_Sensor_OTP_read(0x0442,0,0);
            //wb_unit_r_l    = HI556_Sensor_OTP_read(0x0443,0,0);
            //wb_unit_b_h    = HI556_Sensor_OTP_read(0x0444,0,0);
            //wb_unit_b_l    = HI556_Sensor_OTP_read(0x0445,0,0);
            //wb_unit_gr_h   = HI556_Sensor_OTP_read(0x0446,0,0);
            //wb_unit_gr_l   = HI556_Sensor_OTP_read(0x0447,0,0);
            //wb_unit_gb_h   = HI556_Sensor_OTP_read(0x0448,0,0);
            //wb_unit_gb_l   = HI556_Sensor_OTP_read(0x0449,0,0);
            //wb_golden_r_h  = HI556_Sensor_OTP_read(0x044A,0,0);
            //wb_golden_r_l  = HI556_Sensor_OTP_read(0x044B,0,0);
            //wb_golden_b_h  = HI556_Sensor_OTP_read(0x044C,0,0);
            //wb_golden_b_l  = HI556_Sensor_OTP_read(0x044D,0,0);
            //wb_golden_gr_h = HI556_Sensor_OTP_read(0x044E,0,0);
            //wb_golden_gr_l = HI556_Sensor_OTP_read(0x044F,0,0);
            //wb_golden_gb_h = HI556_Sensor_OTP_read(0x0450,0,0);
            //wb_golden_gb_l = HI556_Sensor_OTP_read(0x0451,0,0);
            wbcheck        = HI556_Sensor_OTP_read(0x0453,0,0);

			/* zhangdong add for otp info start */
		/*	hw_info_sub_otp.otp_valid = hi556_otp_info.wb_flag;
			hw_info_sub_otp.version = 0;
			hw_info_sub_otp.year = HI556_Sensor_OTP_read(0x0504,0,0);
			hw_info_sub_otp.month = HI556_Sensor_OTP_read(0x0505,0,0);
			hw_info_sub_otp.day = HI556_Sensor_OTP_read(0x0506,0,0);
			hw_info_sub_otp.vendor_id = HI556_Sensor_OTP_read(0x0502,0,0);
			hw_info_sub_otp.lens_id = HI556_Sensor_OTP_read(0x0508,0,0);
			hw_info_sub_otp.vcm_id = HI556_Sensor_OTP_read(0x0509,0,0);
	      */
			/* zhangdong add for otp info end */
            break;
        case 0x13:	//Group2 valid
            wb_unit_rg_h   = HI556_Sensor_OTP_read(0x0454,0,0);
            wb_unit_rg_l   = HI556_Sensor_OTP_read(0x0455,0,0);
            wb_unit_bg_h   = HI556_Sensor_OTP_read(0x0456,0,0);
            wb_unit_bg_l   = HI556_Sensor_OTP_read(0x0457,0,0);
            wb_unit_gg_h   = HI556_Sensor_OTP_read(0x0458,0,0);
            wb_unit_gg_l   = HI556_Sensor_OTP_read(0x0459,0,0);
            wb_golden_rg_h = HI556_Sensor_OTP_read(0x045A,0,0);
            wb_golden_rg_l = HI556_Sensor_OTP_read(0x045B,0,0);
            wb_golden_bg_h = HI556_Sensor_OTP_read(0x045C,0,0);
            wb_golden_bg_l = HI556_Sensor_OTP_read(0x045D,0,0);
            wb_golden_gg_h = HI556_Sensor_OTP_read(0x045E,0,0);
            wb_golden_gg_l = HI556_Sensor_OTP_read(0x045F,0,0);
            //wb_unit_r_h    = HI556_Sensor_OTP_read(0x0460,0,0);
            //wb_unit_r_l    = HI556_Sensor_OTP_read(0x0461,0,0);
            //wb_unit_b_h    = HI556_Sensor_OTP_read(0x0462,0,0);
            //wb_unit_b_l    = HI556_Sensor_OTP_read(0x0463,0,0);
            //wb_unit_gr_h   = HI556_Sensor_OTP_read(0x0464,0,0);
            //wb_unit_gr_l   = HI556_Sensor_OTP_read(0x0465,0,0);
            //wb_unit_gb_h   = HI556_Sensor_OTP_read(0x0466,0,0);
            //wb_unit_gb_l   = HI556_Sensor_OTP_read(0x0467,0,0);
            //wb_golden_r_h  = HI556_Sensor_OTP_read(0x0468,0,0);
            //wb_golden_r_l  = HI556_Sensor_OTP_read(0x0469,0,0);
            //wb_golden_b_h  = HI556_Sensor_OTP_read(0x046A,0,0);
            //wb_golden_b_l  = HI556_Sensor_OTP_read(0x046B,0,0);
            //wb_golden_gr_h = HI556_Sensor_OTP_read(0x046C,0,0);
            //wb_golden_gr_l = HI556_Sensor_OTP_read(0x046D,0,0);
            //wb_golden_gb_h = HI556_Sensor_OTP_read(0x046E,0,0);
            //wb_golden_gb_l = HI556_Sensor_OTP_read(0x046F,0,0);
            wbcheck        = HI556_Sensor_OTP_read(0x0471,0,0);

			/* zhangdong add for otp info start */
			/*hw_info_sub_otp.otp_valid = hi556_otp_info.wb_flag;
			hw_info_sub_otp.version = 0;
			hw_info_sub_otp.year = HI556_Sensor_OTP_read(0x0515,0,0);
			hw_info_sub_otp.month = HI556_Sensor_OTP_read(0x0516,0,0);
			hw_info_sub_otp.day = HI556_Sensor_OTP_read(0x0517,0,0);
			hw_info_sub_otp.vendor_id = HI556_Sensor_OTP_read(0x0513,0,0);
			hw_info_sub_otp.lens_id = HI556_Sensor_OTP_read(0x0519,0,0);
			hw_info_sub_otp.vcm_id = HI556_Sensor_OTP_read(0x051A,0,0);
			*/
			/* zhangdong add for otp info end */
            break;
        case 0x37:	//Group3 valid
            wb_unit_rg_h   = HI556_Sensor_OTP_read(0x0472,0,0);
            wb_unit_rg_l   = HI556_Sensor_OTP_read(0x0473,0,0);
            wb_unit_bg_h   = HI556_Sensor_OTP_read(0x0474,0,0);
            wb_unit_bg_l   = HI556_Sensor_OTP_read(0x0475,0,0);
            wb_unit_gg_h   = HI556_Sensor_OTP_read(0x0476,0,0);
            wb_unit_gg_l   = HI556_Sensor_OTP_read(0x0477,0,0);
            wb_golden_rg_h = HI556_Sensor_OTP_read(0x0478,0,0);
            wb_golden_rg_l = HI556_Sensor_OTP_read(0x0479,0,0);
            wb_golden_bg_h = HI556_Sensor_OTP_read(0x047A,0,0);
            wb_golden_bg_l = HI556_Sensor_OTP_read(0x047B,0,0);
            wb_golden_gg_h = HI556_Sensor_OTP_read(0x047C,0,0);
            wb_golden_gg_l = HI556_Sensor_OTP_read(0x047D,0,0);
            //wb_unit_r_h    = HI556_Sensor_OTP_read(0x047E,0,0);
            //wb_unit_r_l    = HI556_Sensor_OTP_read(0x047F,0,0);
            //wb_unit_b_h    = HI556_Sensor_OTP_read(0x0480,0,0);
            //wb_unit_b_l    = HI556_Sensor_OTP_read(0x0481,0,0);
            //wb_unit_gr_h   = HI556_Sensor_OTP_read(0x0482,0,0);
            //wb_unit_gr_l   = HI556_Sensor_OTP_read(0x0483,0,0);
            //wb_unit_gb_h   = HI556_Sensor_OTP_read(0x0484,0,0);
            //wb_unit_gb_l   = HI556_Sensor_OTP_read(0x0485,0,0);
            //wb_golden_r_h  = HI556_Sensor_OTP_read(0x0486,0,0);
            //wb_golden_r_l  = HI556_Sensor_OTP_read(0x0487,0,0);
            //wb_golden_b_h  = HI556_Sensor_OTP_read(0x0488,0,0);
            //wb_golden_b_l  = HI556_Sensor_OTP_read(0x0489,0,0);
            //wb_golden_gr_h = HI556_Sensor_OTP_read(0x048A,0,0);
            //wb_golden_gr_l = HI556_Sensor_OTP_read(0x048B,0,0);
            //wb_golden_gb_h = HI556_Sensor_OTP_read(0x048C,0,0);
            //wb_golden_gb_l = HI556_Sensor_OTP_read(0x048D,0,0);
            wbcheck        = HI556_Sensor_OTP_read(0x048F,0,0);

			/* zhangdong add for otp info start */
			/*
			hw_info_sub_otp.otp_valid = hi556_otp_info.wb_flag;
			hw_info_sub_otp.version = 0;
			hw_info_sub_otp.year = HI556_Sensor_OTP_read(0x0526,0,0);
			hw_info_sub_otp.month = HI556_Sensor_OTP_read(0x0527,0,0);
			hw_info_sub_otp.day = HI556_Sensor_OTP_read(0x0528,0,0);
			hw_info_sub_otp.vendor_id = HI556_Sensor_OTP_read(0x0524,0,0);
			hw_info_sub_otp.lens_id = HI556_Sensor_OTP_read(0x052A,0,0);
			hw_info_sub_otp.vcm_id = HI556_Sensor_OTP_read(0x052B,0,0);
			*/
			/* zhangdong add for otp info end */
            break;
        default:
            printk("hi556_otp HI556_Sensor: wb_flag error value: 0x%x\n ",hi556_otp_info.wb_flag);
        break;
    }

    printk("hi556_otp wb_unit_rg_h = 0x%x, wb_unit_rg_l = 0x%x, wb_unit_bg_h = 0x%x, wb_unit_bg_l = 0x%x, wb_golden_rg_h = 0x%x, wb_golden_rg_l = 0x%x, wb_golden_bg_h = 0x%x, wb_golden_bg_l = 0x%x,  wbcheck = 0x%x\n", 
    ...
    printk("hi556_otp Read from module: rg_golden_value = 0x%x, bg_golden_value = 0x%x\n", rg_golden_value, bg_golden_value);
    printk("hi556_otp Read from module: rg_value = 0x%x, bg_value = 0x%x\n",rg_value, bg_value);

    hi556_otp_info.r_gain = (0x100 * RG_Ratio_Typical) / rg_value;
    hi556_otp_info.b_gain = (0x100 * BG_Ratio_Typical) / bg_value;
    hi556_otp_info.g_gain = 0x100;
    if(hi556_otp_info.r_gain < hi556_otp_info.b_gain)
        {
            if(hi556_otp_info.r_gain < 0x100)
            {
                hi556_otp_info.b_gain = 0x100 * hi556_otp_info.b_gain / hi556_otp_info.r_gain;
                hi556_otp_info.g_gain = 0x100 * hi556_otp_info.g_gain / hi556_otp_info.r_gain;
                hi556_otp_info.r_gain = 0x100;
            }
    }
    else
     {
            if(hi556_otp_info.b_gain < 0x100)
            {
                hi556_otp_info.r_gain = 0x100 * hi556_otp_info.r_gain / hi556_otp_info.b_gain;
                hi556_otp_info.g_gain = 0x100 * hi556_otp_info.g_gain / hi556_otp_info.b_gain;
                hi556_otp_info.b_gain = 0x100;
            }
    }
    printk("hi556_otp HI556 After calcuate: g_gain = 0x%x, r_gain = 0x%x,b_gain = 0x%x\n", hi556_otp_info.g_gain,hi556_otp_info.r_gain,hi556_otp_info.b_gain);

}

void HI556_Sensor_update_wb_gain(USHORT rg, USHORT bg, USHORT gg)
{
    ...
    b_gain = bg;
    g_gain = gg;
    printk("hi556_otp r_gain = 0x%x, b_gain = 0x%x\n",r_gain, b_gain);
    HI556_OTP_write_cmos_sensor(0x0078, g_gain >> 8); //g_gain
    HI556_OTP_write_cmos_sensor(0x0079, g_gain & 0xFFFF); //g_gain
    HI556_OTP_write_cmos_sensor(0x007a, g_gain >> 8); //g_gain
    HI556_OTP_write_cmos_sensor(0x007b, g_gain & 0xFFFF); //g_gain

    HI556_OTP_write_cmos_sensor(0x007c, r_gain >> 8); //r_gain
    HI556_OTP_write_cmos_sensor(0x007d, r_gain & 0xFFFF); //r_gain
    HI556_OTP_write_cmos_sensor(0x007e, b_gain >> 8); //b_gain
    HI556_OTP_write_cmos_sensor(0x007f, b_gain & 0xFFFF); //b_gain

    a05 = read_cmos_sensor_otp(0x0a05);
    printk("hi556_otp denis++a05 = %x\n",a05);
}

static void HI556_OTP_cali(void)
{
	printk("hi556_otp get in HI556_OTP_cali\n");
  if(hi556_otp_info.wb_flag == 0x01 || hi556_otp_info.wb_flag == 0x13 || hi556_otp_info.wb_flag == 0x37) {
        HI556_OTPSetting();
        HI556_Sensor_calc_wbdata();
        HI556_Sensor_OTP_info();
        HI556_Sensor_update_wb_gain( hi556_otp_info.r_gain, hi556_otp_info.b_gain, hi556_otp_info.g_gain);
   } else {
        HI556_OTPSetting();
        hi556_otp_info.wb_flag = HI556_Sensor_OTP_read(0x0435,0,0);
        printk("hi556_otp wb_flag = 0x%x\n",hi556_otp_info.wb_flag);
        if (hi556_otp_info.wb_flag == 0x01 || hi556_otp_info.wb_flag == 0x13 || hi556_otp_info.wb_flag == 0x37) {
            HI556_Sensor_calc_wbdata();
            HI556_Sensor_OTP_info();
            HI556_Sensor_update_wb_gain( hi556_otp_info.r_gain, hi556_otp_info.b_gain, hi556_otp_info.g_gain);
   	...
   	printk("hi556_otp get out HI556_OTP_cali\n");
}
...
write_cmos_sensor(0x0f30,0x6025);
...
write_cmos_sensor(0x0a00, 0x0000);
write_cmos_sensor(0x0b0a, 0x8252);
write_cmos_sensor(0x0f30, 0x6025); //pll
...
write_cmos_sensor(0x0f30, 0x6025); //pll  0x6e25                                    
...
UINT32 HI556_CXT_K300_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	hi556_cxt_k300_MIPI_RAW_SensorInit	*/
