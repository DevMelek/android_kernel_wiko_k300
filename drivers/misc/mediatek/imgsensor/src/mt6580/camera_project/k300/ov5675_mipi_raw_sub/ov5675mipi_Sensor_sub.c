...
#define PFX "ov5675_camera_sensor_sub"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV5675MIPI_SENSOR_ID_SUB, //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0x4d88fa8d, //0x523c51f6, //checksum value for Camera Auto Test
...
static imgsensor_struct imgsensor = {
    .mirror = IMAGE_H_MIRROR, //IMAGE_NORMAL, //IMAGE_HV_MIRROR, //mirrorflip information
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    sensor_info->SensorHorFOV = 59;
    sensor_info->SensorVerFOV = 47;
...
UINT32 OV5675_MIPI_RAW_SensorInit_SUB(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*OV5675_MIPI_RAW_SensorInit_SUB*/
