...
#define GC8034_CXT_K300_OTP_FOR_CUSTOMER

#ifdef GC8034_CXT_K300_OTP_FOR_CUSTOMER
#define RG_TYPICAL    		0x04f7//ackman update 20171107 for cxt V10921 module
#define BG_TYPICAL			0x04d4
#define AF_ROM_START  	    0x3b  //AF
