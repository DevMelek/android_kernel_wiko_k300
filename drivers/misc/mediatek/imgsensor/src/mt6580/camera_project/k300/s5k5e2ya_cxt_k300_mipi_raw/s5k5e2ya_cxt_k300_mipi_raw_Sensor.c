 ...
 * Filename:
 * ---------
 *	 s5k5e2ya_cxt_k300mipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "s5k5e2ya_cxt_k300_camera_sensor"
#define LOG_1 LOG_INF("s5k5e2ya_cxt_k300,MIPI 2LANE\n")
...
extern uint16_t s5k5e2ya_cxt_k300_get_otp_module_id(void);
//#define CAPTURE_24FPS

static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K5E2YA_CXT_K300_SENSOR_ID,
	
	.checksum_value = 0xa48ebf5d,//0xb33938bd, //0x41d96921,//0x87e356d9,
...
extern struct otp_info_t Cxt_S5K5E2_OTP; 
extern uint32_t s5k5e2ya_cxt_k300_read_otp_info(struct otp_info_t *S5K5E2_OTP);
extern uint32_t s5k5e2ya_cxt_k300_update_awb(struct otp_info_t *S5K5E2_OTP);

kal_uint16 S5K5E2_CXT_K300_read_cmos_sensor(kal_uint32 addr)
{
...
void S5K5E2_CXT_K300_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			*sensor_id  = *sensor_id + 2;
			LOG_INF("Read sensor sensor_id =  0x%x\n", *sensor_id);
...
static kal_uint32 open(void)
{
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	s5k5e2ya_cxt_k300_read_otp_info(&Cxt_S5K5E2_OTP);
	/* initail sequence write in  */
	sensor_init();
    s5k5e2ya_cxt_k300_update_awb(&Cxt_S5K5E2_OTP);
	spin_lock(&imgsensor_drv_lock);
...
UINT32 S5K5E2YA_CXT_K300_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
